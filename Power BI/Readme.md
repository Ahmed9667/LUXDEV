1. Power BI Data Model (Setup Instructions)To get the best results in Power BI, set up your relationships as follows:Table 1: Patients (Primary Key: Patient_ID)Table 2: Visits (Primary Key: Visit_ID, Foreign Key: Patient_ID)Relationship: Patients (1) $\rightarrow$ Visits (*) on Patient_ID.Table 3: Pharmacy_Transactions (Foreign Key: Visit_ID)Relationship: Visits (1) $\rightarrow$ Pharmacy_Transactions (*) on Visit_ID.
